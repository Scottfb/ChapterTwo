...
public class Names
{
        ...
        public static void main (String[] args)
        {
         ...
         System.out.println ("\tAlexander\tWashington\t\tWomen's Studies");
         System.out.println ("\tEddie\t\tLondon\t\t\tConspiracy Theories");
         System.out.println ("\tAlex\t\tSan Francisco\t\tBusiness");
         System.out.println ();
        }
}
